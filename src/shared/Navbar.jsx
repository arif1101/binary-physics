...
const Navbar = () => {
    ...
    return (
        <div className='w-screen shadow max-h-[76px] fixed top-0 left-0 bg-white z-50'>
        ...
        <div className="navbar-start">
            ...
            <img className='w-[112px] h-[70px] my-auto flex items-center justify-center' src="/logo.png" alt="" />
        </div>
        ...
        <div className="navbar-end flex gap-[16px]">
            ...
            <label className="swap swap-rotate bg-stone-200 rounded-full p-1">
